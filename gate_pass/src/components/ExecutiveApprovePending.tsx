...
import "../styles/executiveapprovepending.css";

const ExecutiveApprovePending: React.FC = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="header">
        <h2>Executive Approve <span className="arrow">➝</span> <span className="status pending">Pending</span></h2>
...
export default ExecutiveApprovePending;
