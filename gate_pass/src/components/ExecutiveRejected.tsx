...
const ExecutiveRejected: React.FC = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="header">
        <h2>Executive Approve <span className="arrow">➝</span> <span className="status pending">Rejected</span></h2>
...
export default ExecutiveRejected;
